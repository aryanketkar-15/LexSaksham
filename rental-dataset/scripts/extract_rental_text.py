...
# Folders
# -------------------------
raw_folder = os.path.join(BASE_PATH, "rental-dataset", "raw_docs")
txt_folder = os.path.join(BASE_PATH, "rental-dataset", "clauses_raw")
...
# -------------------------
data_list = []  # 👈 collect all processed docs for all_agreements.csv
...
# --- Save all text to a CSV (Step B output)
if data_list:
