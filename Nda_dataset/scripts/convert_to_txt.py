...
# Folders
# -------------------------
raw_folder = os.path.join(BASE_PATH, "Nda_dataset", "raw_docs")
txt_folder = os.path.join(BASE_PATH, "Nda_dataset", "clauses_raw")
...
# -------------------------
data_list = []  # 👈 to collect everything for all_agreements.csv
