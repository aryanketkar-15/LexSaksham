      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Welcome! Upload contracts, get AI-powered analysis, and understand your legal documents.
          </p>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {totalContracts === 0 ? 'No contracts yet' : `${totalContracts} document${totalContracts > 1 ? 's' : ''} uploaded`}
            </p>
          </CardContent>
        </Card>
